...
# Example usage
input_dir = "C:\\Dian\\SmartHouse\\Test\\PhoWhisper\\test_set\\audio"  # Path to your input sample audio file
output_dir = "C:\\Dian\\SmartHouse\\Test\\PhoWhisper\\test_set\\audio_with_noise"  # Directory to save the noisy audio files
