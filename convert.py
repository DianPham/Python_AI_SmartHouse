...
folder_path = "C:/Users/DELL.DESKTOP-TETDMA3/Downloads/my"  # Replace with the path to your folder containing the .m4a files
names_file = "C:/Users/DELL.DESKTOP-TETDMA3/Downloads/name.txt"  # Replace with the path to your names file
...
files = sorted([f for f in os.listdir(folder_path) if f.startswith("my") and f.endswith(".m4a")], key=extract_number)
...
if len(new_names) != len(files):
    ...
    for index, file_name in enumerate(files):
        ...
        new_file_name = f"nu_my_nam_{new_name}.m4a"
